...
urlpatterns = [
    ...
    path("auth/oauth/google/start", google_oauth_start),
    path("auth/oauth/google/callback", google_oauth_callback),
    path("auth/oauth/linkedin/start", linkedin_oauth_start),
    path("auth/oauth/linkedin/callback", linkedin_oauth_callback),
